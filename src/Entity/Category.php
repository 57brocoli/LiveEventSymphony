...
#[ApiResource(
    operations:[
        new Get(normalizationContext:['groups' => ['getforCategory']]),
        new GetCollection(normalizationContext:['groups' => ['getforCategory']]),
    ]
)]
class Category
{
    ...
    #[ORM\ManyToMany(mappedBy: 'category', targetEntity: Event::class)]
